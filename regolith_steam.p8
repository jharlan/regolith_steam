...
function draw_upper()
  ...
  print(" "..tostr(player.lvl).."/"..tostr(#lvl_list),92,3,15)
  print("goal",73,11,1)
  print("goal",72,10,8)
  draw_goal()
  pal(4,1)
...
function draw_vert_meters()
  ...
  printv("shield",114,19,player.d>16 and 2 or 8)
  printv("shield",113,18,15)

  printv("fuel",120,27,player.w>16 and 2 or 8)
  printv("fuel",119,26,15)
  ...
  -- sensor
  --rectfill(5,110-player.sensor[2],7,110,10)
  --rectfill(11,110-player.sensor[1],13,110,14)

  -- coins
  spr(coin.spr[2][2],3,36-coin.offset[2])
  spr(coin.spr[2][1],2,35-coin.offset[2])

  -- pink
  spr(coin.spr[1][2],9,36-coin.offset[1])
  spr(coin.spr[1][1],8,35-coin.offset[1])

  spr(coin.spr[1][2],9,28-coin.offset[1])
...

...
000000003b3000000000000000000000000000000000000000000000007000000750570077777000000000000000000000000000000000000000000000000000
...

