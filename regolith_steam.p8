...
function draw_goal()
  for i=0,clvl.goal-1 do
    ...
    pal(2,1)
    spr(98,67+i*4+26+2,10)
    pal()
    spr(gspr,67+i*4+29,9)
  end
end
...
function draw_upper()
  ...
  print(" 00"..tostr(player.lvl),95,3,15)
  print("goal",74,11,1)
  print("goal",75,10,8)
  draw_goal()
  pal(4,1)
...

